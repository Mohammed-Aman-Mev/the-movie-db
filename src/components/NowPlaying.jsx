...
const NowPlaying = () => {
  ...
  return (
    <div className="w-full h-[350px] flex items-center justify-center p-3">
      <div className="w-full bg-pink-300 h-full flex p-2 ">
        <div className="w-[250px] h-[300px] bg-slate-300 rounded-md border-2 border-red-900"></div>
        <div className="w-[250px] h-[300px] bg-slate-300 rounded-md border-2 border-red-900"></div>
        <div className="w-[250px] h-[300px] bg-slate-300 rounded-md border-2 border-red-900"></div>
        <div className="w-[250px] h-[300px] bg-slate-300 rounded-md border-2 border-red-900"></div>
        <div className="w-[250px] h-[300px] bg-slate-300 rounded-md border-2 border-red-900"></div>
